...
{
    public class PassportsHashEntityTypeConfiguration : IEntityTypeConfiguration<PassportsHash>
    {
        public void Configure(EntityTypeBuilder<PassportsHash> builder)
        {
            builder.ToTable("passports_hash");
            ...
            builder.Property(p => p.PassportHash).HasColumnName("passport_hash").IsRequired(false);
